"""
Django settings for paolo_map project.
...
SECRET_KEY = 'django-insecure-qm2g=9_-b*po&jzdwwg$qzw(4t==js9dpp=on^$o5jcd_4^!$s'
...
WSGI_APPLICATION = 'paolo_map.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'paolo_map','static'),
